                                                ...
                                                <div class="row p-5">
                                                    ...
                                                    <div class="col-sm-12 col-md-12 col-lg-7 pb-5">
                                                        ...
                                                        <div class="example-preview">
                                                            <p><code>Clash</code>是一款用 Go语言 开发的支持 Linux/MacOS/Windows/Android 等多平台的代理工具，支持 ss/v2ray/ssr，支持规则分流（类似于 Surge 的配置）。</p>
...
<!-- 开始 :: 内容段落 2 -->
                                                <div class="row p-5">
                                                    ...
                                                    <div class="col-sm-12 col-md-12 col-lg-5">
                                                        <a class="image-popup-no-margins" href="{$metron['assets_url']}/media/tutorial/windows/clashr/clashr.png" data-lightbox="images">
                                                        <img class="rounded-lg" style="width:100%" src="/theme/metron/images/clash_win_1.png"/></a>
                                                    </div>
                                                    <!-- 结束 :: 图片 -->
                                                </div>
<!-- 结束 :: 内容段落 2 -->
...
<!-- 开始 :: 内容段落 3 -->
                                                <div class="row p-5">
                                                    <div class="col-sm-12 col-md-12 col-lg-7 pb-5">
                                                        ...
                                                        {/if}
                                                        <!-- 结束 :: 订阅按钮 -->
                                                        <div class="h6 pt-2">点击上方按钮一键导入节点配置到Clash</div>
                                                        <div class="h6 pt-2">导入成功后， <code>Profiles(汉化版本为“配置”)</code> 界面会多出一个配置选项卡</div>
                                                        <div class="h6 pt-2">点击选中刚刚导入的配置选项卡</div>
                                                        <div class="h6 pt-2">如果弹出配置错误提示，请重启客户端并重新选中刚刚导入的配置</div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-12 col-lg-5">
                                                        <a class="image-popup-no-margins" href="{$metron['assets_url']}/media/tutorial/windows/clashr/clashr.png" data-lightbox="images">
                                                        <img class="rounded-lg" style="width:100%" src="/theme/metron/images/clash_win_2.png"/></a>
                                                    </div>
                                                </div>
<!-- 结束 :: 内容段落 3 -->
...
<!-- 开始 :: 内容段落 4 -->
                                                <div class="row p-5">
                                                    ...
                                                    <div class="col-sm-12 col-md-12 col-lg-5">
                                                        <a class="image-popup-no-margins" href="{$metron['assets_url']}/media/tutorial/windows/clashr/clashr.png" data-lightbox="images">
                                                        <img class="rounded-lg" style="width:100%" src="/theme/metron/images/clash_win_3.png"/></a>
                                                    </div>
                                                </div>
<!-- 结束 :: 内容段落 4 -->
...
<!-- 开始 :: 内容段落 5 -->
                                                <div class="row p-5">
                                                    ...
                                                    <div class="col-sm-12 col-md-12 col-lg-5">
                                                        <a class="image-popup-no-margins" href="{$metron['assets_url']}/media/tutorial/windows/clashr/clashr.png" data-lightbox="images">
                                                        <img class="rounded-lg" style="width:100%" src="/theme/metron/images/clash_win_4.png"/></a>
                                                    </div>
                                                </div>
<!-- 结束 :: 内容段落 5 -->
